...
export interface SiltflowAPI {
  ...
  sync: {
    ...
    registerDevice: (serverUrl: string, serverToken: string, deviceName: string, deviceId?: string) => Promise<import("@siltflow/shared-lib").AuthRegisterResponse>
...
const api: SiltflowAPI = {
  ...
  sync: {
    ...
    registerDevice: (serverUrl, serverToken, deviceName, deviceId) => ipcRenderer.invoke('sync:register', serverUrl, serverToken, deviceName, deviceId),
