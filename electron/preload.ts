...
const api: SiltflowAPI = {
  ...
  showInFolder: (docId) => ipcRenderer.invoke("shell:showItemInFolder", docId),
  ...
  documents: {
    ...
    updateMetadata: (params) =>
      ipcRenderer.invoke("documents:updateMetadata", params),
  ...
  annotations: {
    ...
    delete: (id, documentId) =>
      ipcRenderer.invoke("annotations:delete", id, documentId),
  },
  summaries: {
  ...
  aiResults: {
    get: (annotationId, documentId) =>
      ipcRenderer.invoke("aiResults:get", annotationId, documentId),
    listByDocument: (documentId) =>
      ipcRenderer.invoke("aiResults:listByDocument", documentId),
    save: (
      annotationId: string,
      documentId: string,
      data: unknown,
      ...
      ipcRenderer.invoke("aiResults:save", {
        annotationId,
        documentId,
        data,
        version,
      }),
    delete: (annotationId, documentId) =>
      ipcRenderer.invoke("aiResults:delete", annotationId, documentId),
  },
  fsrsCards: {
    get: (annotationId, documentId) =>
      ipcRenderer.invoke("fsrsCards:get", annotationId, documentId),
    save: (annotationId, documentId, data) =>
      ipcRenderer.invoke("fsrsCards:save", { annotationId, documentId, data }),
    delete: (annotationId, documentId) =>
      ipcRenderer.invoke("fsrsCards:delete", annotationId, documentId),
    listByDocument: (documentId) =>
      ipcRenderer.invoke("fsrsCards:listByDocument", documentId),
    listAll: () => ipcRenderer.invoke("fsrsCards:listAll"),
  },
  reviewLogs: {
    listByAnnotation: (annotationId, documentId) =>
      ipcRenderer.invoke(
    ...
    save: (annotationId, documentId, data) =>
      ipcRenderer.invoke("reviewLogs:save", { annotationId, documentId, data }),
  },
  folders: {
    list: () => ipcRenderer.invoke("folders:list"),
    create: (params: { name: string; parentId?: string | null }) =>
      ipcRenderer.invoke("folders:create", params),
    rename: (params: { id: string; name: string }) =>
      ipcRenderer.invoke("folders:rename", params),
    delete: (id: string) => ipcRenderer.invoke("folders:delete", id),
    moveDocuments: (params: {
      docIds: string[];
      targetFolderId: string | null;
    }) => ipcRenderer.invoke("folders:moveDocuments", params),
    moveFolder: (params: { folderId: string; targetParentId: string | null }) =>
      ipcRenderer.invoke("folders:moveFolder", params),
  },
  review: {
