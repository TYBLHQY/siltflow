...
export const DEFAULT_SHORTCUTS: ShortcutEntry[] = [
  ...
  { actionId: "backFromLearning",      label: "Back from learning", context: "learning-mode",    defaultKeys: "escape",      keys: "escape", locked: true },
]
...
export async function loadShortcutsFromVault() {
  try {
    ...
    const saved = (cfg as Record<string, unknown>)[VAULT_KEY] as Record<string, string> | undefined
