 ...
 * Each function takes raw data and returns chart-ready arrays.
 */
import { State } from "ts-fsrs";
import type { Card } from "ts-fsrs";
import { retrievability } from "./doc-review.js";
...
export { GRADE_NAMES, GRADE_COLORS };

/** Parse the data field of a review_log row. */
function parseLogData(raw: string): {
  grade: number;
  log: { state: number; stability: number; difficulty: number; scheduled_days: number };
  card: { due: string; stability: number; difficulty: number; scheduled_days: number; reps: number; lapses: number; state: number };
} {
  return JSON.parse(raw);
}

// ---------------------------------------------------------------------------
// Daily Reviews / New vs Review
// ---------------------------------------------------------------------------
